...
# printch : Print Text with Color and Highlight
def printch(text, color_text='white', highlight_text='green'):
    """
    Prints logs with color and highlights according to color
    """
    color_print(f"{text}", color=color_text, highlight=highlight_text)
